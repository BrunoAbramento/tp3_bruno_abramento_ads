package com.example.tp3_bruno_abramento_ads
...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "6249ca47a2a0afaed0fed874436009fa"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>()
    {
        ...
        override fun doInBackground(vararg p0: String?): String? {
            ...
            try {
                ...
                var response = URL("https://api.openweathermap.org/data/2.5/weather?q=$CITY&units=metric&appid=$API").readText(
                    Charsets.UTF_8
                )
                return response
